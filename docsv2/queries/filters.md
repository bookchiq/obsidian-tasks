...
If your date searches are giving unexpected results, add an [[queries/explaining-queries|`explain`]] line to your query.
...
See [[getting-started/dates#-created|created date]] for how to make Tasks record the created date on any task lines that it creates.
...
Unchanged interpretation of various [[queries/filters#absolute-dates|**absolute** due date]] filters:
...
Differences in interpretation of various [[queries/filters#absolute-date-ranges|**absolute** due date **range**]] filters:
...
Differences in interpretation of various [[queries/filters#relative-date-ranges|**relative** due date **range**]] filters, when run on `2023-02-10` (Friday 10th February 2023):
...
>
> For comparison, you can view [this page on the old documentation site](https://obsidian-tasks-group.github.io/obsidian-tasks/queries/filters/).
...
>
> If you notice any other problems in this page, compared to [the old one](https://obsidian-tasks-group.github.io/obsidian-tasks/queries/filters/), please let us know in [#1706](https://github.com/obsidian-tasks-group/obsidian-tasks/issues/1706#issuecomment-1454284835).
>
> Please include:
>
